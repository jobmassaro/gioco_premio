      ...
      <table width="100%" border="0">
        ...
        <tr>
          <td> Esercizio:</td>
            ...
            <tr><td>Importo:</td>
            <td><input type="text" name="importo1" id="importo1"  /></td>
            <!--<td><input name="number" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')"></td>-->
           <!--<td> <input type="text"  pattern="[0-9]{3}" title="Three letter country code" name="importo1" id="importo1" onkeypress="return handleEnter(this, event)"/></td> -->
        </tr>
...
$("#invio1").click(function() {
	...
	/*		if ($("#numero1").val() == '') {
      ...
      $('#tableScontrini').hide();
	    ...
	    $('#tableScontrini').html("");
	  	$.get('../request/tableScontrini.php',{'esercizio':$('#esercizio1').val(),'numero':$('#numero1').val(),'data':$('#datepicker50').val(),'barcode':$('#barcode1').val(),'importo':$('#importo1').val(),'voto':$('#voto1').val(),'application':'concorsi','check':check_active},function(html){
	    $('#tableScontrini').show();
