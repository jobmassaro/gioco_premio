...
<div ng-controller="nuovaTesseraCtrl">
  ...
  <tr>
    ...
    <td><input type="text" name="nome"  id="nome" class="required" size="30"  ng-model="item.nome" placeholder="nome" required/></td>
  </tr>
  <tr>
    <td><label for="cognome">Cognome</label>			
</td>
    <td><input type="text" name="cognome"  id="cognome" class="required" size="30" onkeypress="return handleEnter(this, event)" ng-model="item.cognome" placeholder="cognome" required/></td>
  </tr>
  <tr>
    <td><label for="indirizzo">Indirizzo</label>				
</td>
    <td><input type="text" value="xxx" name="indirizzo"  id="indirizzo" class="required" size="30" onkeypress="return handleEnter(this, event)" ng-model="item.indirizzo" ng-init="item.indirizzo='XXX'" /></td>
  </tr>
   <tr>
    <td><label for="civile">Numero Civico</label>				
</td>
    <td><input type="text" name="civico"  id="civico" class="required" size="30" onkeypress="return handleEnter(this, event)" ng-model="item.civico" placeholder="civico" ng-init="item.civico='101'" /></td>
  </tr>
  <tr>
    <td><label for="comune">Comune</label>	
</td>
    <td><input type="text" name="comune"  id="comune" class="required" size="30" onkeypress="return handleEnter(this, event)" ng-model="item.comune" placeholder="comune"  ng-init="item.comune='XXXXX'"/></td>
  </tr>
  <tr>
    <td><label for="cap">CAP</label>	
</td>
    <td><input type="text" name="cap"  id="cap" class="required" size="6" onkeypress="return handleEnter(this, event)" ng-model="item.cap" placeholder="cap"  ng-init="item.cap='101010'"/></td>
  </tr>
  <tr>
    <td><label for="prv">Provincia</label>
</td>
    <td><input type="text" name="prv"  id="prv" class="required" size="2" maxlength="2" onkeypress="return handleEnter(this, event)" ng-model="item.prv" placeholder="provincia" ng-init="item.prv='XX'"/></td>
  </tr>
  <?php if ($giococompleto->datanumero) { ?>
   <tr>
    <td><label for="nascita">Data di nascita</label>
</td>
    <td><input type="text" name="nascita"  id="nascita" class="required" size="11" onkeypress="return handleEnter(this, event)" ng-model="item.nascita" placeholder="nascita" value="01/01/1900" ng-init="item.nascita='XX/XX/XXXX'"/></td>
  </tr>
 <?php }else{ ?>
   <tr>
    <td><label for="nascita">Data di nascita</label>
</td>
    <td><input type="text" name="nascita"  id="datepicker" class="required" size="11" onkeypress="return handleEnter(this, event)" ng-model="item.nascita" placeholder="nascita"  value="01/01/1900" ng-init="item.nascita='XX/XX/XXXX'"/></td>
  </tr>
 <?php } ?>
  <tr>
  ...
  <tr>
    ...
    <td><input type="text" name="telefono"  id="telefono" class="required" size="30" onkeypress="return handleEnter(this, event)" ng-model="item.telefono" placeholder="telefono" ng-init="item.telefono='111111'"/></td>
  </tr>
  <tr>
    <td><label for="mobile">Cellulare</label>				
</td>
    <td><input type="text" name="mobile"  id="mobile" class="required" size="30" onkeypress="return handleEnter(this, event)" ng-model="item.mobile" placeholder="mobile"  ng-init="item.mobile='11111'"/></td>
  </tr>
  <tr>
    <td><label for="email">Email</label>
</td>
    <td><input type="email" name="email"  id="email" class="required" size="30" onkeypress="return handleEnter(this, event)" ng-model="item.email" placeholder="email"  ng-init="item.email='xxx@xxxx.xxx'" required/></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
...
alert("ATTENZIONE DEVI ACCETTARE ANCHE LA PRIVACY ")
frm.sesso.focus();
return false;
}
